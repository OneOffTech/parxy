from parxy_core.models import (
    BoundingBox, Style, Character, Span, Line,
    TextBlock, ImageBlock, TableBlock, Page, Metadata, Document
)
...
class TestModels:
    ...
    def test_span(self):
        ...
        chars = [
            Character(text="H", page=1),
            Character(text="i", page=1)
        ]
        span = Span(
            text="Hi",
            bbox=bbox,
    ...
    def test_line(self):
        ...
        spans = [
            Span(text="Hello", page=1),
            Span(text="World", page=1)
        ]
        line = Line(
            text="Hello World",
            bbox=bbox,
    ...
    def test_text_block(self):
        ...
        lines = [
            Line(text="First line", page=1),
            Line(text="Second line", page=1)
        ]
        block = TextBlock(
            type="text",
            bbox=bbox,
